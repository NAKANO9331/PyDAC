...
pytest tests/unit/ --json-report --json-report-file=result/unit_test_results.json
```
...
```bash
# Run all DSL test cases (12 cases)
python3 scripts/test/test_pydac_dsl_cases.py --output result/pydac_test_report.json

# Run specific test case
python3 scripts/test/test_pydac_dsl_cases.py --test matMul

# Specify translation mode (USM or Buffer)
...
Options:
  ...
  --mode {usm,buffer}       Translation mode (default: usm)
  ...
  --output FILE             Specify output report file (default: result/pydac_test_report.json)
```
...
```bash
# Run all test cases
python3 scripts/test/comprehensive_test_dacpp_cases.py --output result/test_report.json
...
python3 visualization/generate_visualizations.py --type dsl --input result/pydac_test_report.json
```
...
python3 visualization/generate_visualizations.py --type dacpp --input result/test_report.json
```
...
python3 visualization/generate_visualizations.py --type unit --input result/unit_test_results.json
```
